...
It is’s super easy to use H6NSDK with a CMake-based project.  Bbecause H6NSDK itself is built with CMake, so you can take advantage of the CMake target system to simplify your build scripts.
